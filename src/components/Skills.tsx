...
export default function Skills() {
  const educations = [
    {
      name: "Superior em Análise e Desenvolvimento de Sistemas - UNIP Sorocaba"
    },
    {
      name: "Curso de Desenvolvimento Web Full Stack | Dev Samurai",
    },
    {
      name: "Curso de Desenvolvimento Node | Dev Samurai",
    },
    {
      name: "Formação Front-End | Alura"
    },
    {
      name: "Node.js do Zero à Maestria - Matheus Battisti | Udemy"
    }
      ...
      <div className="container mx-auto max-w-4xl p-4 py-12">
        <div className="relative mb-4 p-4 text-center">
          ...
          <p className="relative text-sm text-gray-700">
            Back-End Developer| Node.js | Express.js| React.js | JavaScript | SQL
          </p>
