...
export default function Projects() {
  const projects = [
    {
      title: "Back-End: User Auth System",
      description: "Projeto de uma API com autenticação de usuário",
      image:
      ...
      link: "https://github.com/envhi/auth-crud",
      colSpan: "col-span-1",
    },
    {
      title: "Full-Stack: Lista de Tarefas",
      description: "Projeto Full Stack com MongoDB, Express, React, Node",
      image:
      ...
      link: "https://github.com/envhi/To-Do-App",
      colSpan: "col-span-1 md:col-span-2",
    },
    {
      title: "Front-End: Portfolio",
      description: "Projeto deste portfolio, desenvolvido em React",
      image:
