...
export default function Contact() {
  ...
  const contacts = [
    {
      name: "WhatsApp",
      description: "+55 15 9.9655-8555",
      link: "https://wa.me/5515996558555?text=Olá...",
      icon: <FaWhatsapp className="h-10 w-10" />,
    },
    {
      name: "Email",
      description: "devfelipefonseca@gmail.com",
      link: "mailto:devfelipefonseca@gmail.com?subject=Olá...",
    ...
    <section id="contact" className="bg-blue-700 text-white">
      <div className="container mx-auto max-w-4xl p-4 py-8">
        <div className="mb-6">
          ...
          <p className="text-sm">
            Entre em contato comigo pelo formulário ou meu WhatsApp!
          </p>
        </div>
